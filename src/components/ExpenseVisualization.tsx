  ...
  return (
    ...
    >
      <TouchableOpacity
        ...
        activeOpacity={1}
      >
        <Card variant="elevated" padding="md" className="border border-slate-200 dark:border-slate-700">
          <View className="mb-4">
            <View
          ...
          {/* Progress Bar */}
          <View className="mt-2">
            <View className="h-2 bg-slate-100 dark:bg-slate-700 rounded-full overflow-hidden shadow-sm">
              <Animated.View
